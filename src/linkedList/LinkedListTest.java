...
public class LinkedListTest {
    ...
    public static void main(String args[]) {
        System.out.println("Initialization of Data in LinkedList");
        initData();
        System.out.println("Reading Data from LinkedList");
        readList(models);
        System.out.println("Adding Data from LinkedList");
        addData();

        System.out.println("Reading Data from LinkedList");
        readList(models);

        System.out.println("Searching Data from LinkedList");
        searchData(models);

        System.out.println("Removing Data from LinkedList");
        removeData();
    ...
    private static void searchData(List<Model> models){
        if(models.size() > 0) {
            ...
            int index = models.indexOf(myModel);
            System.out.print("MyModel Found in " + index + "number");
